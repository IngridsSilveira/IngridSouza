  ...
  return (
    <>
      <section id="Contact" className="fSection hidden">
        ...
        <p className="description hidden" id="wantContact">
          Want to contact me?
        </p>
        <p className="form_description hidden" id="preenchaContact">
        ...
        <form id="form" className="form hidden" onSubmit={sendEmail}>
          <fieldset>
            <div className="input-container">
              <label className="titulos-black" htmlFor="name">Nome:</label>
              <input
                name="name"
                id="nome"
            ...
            <div className="input-container">
              <label className="titulos-black" htmlFor="email">E-mail:</label>
            ...
            <div className="input-container">
              <label className="titulos-black" htmlFor="message">Mensagem:</label>
            ...
            <input
              id="submit"
              type="submit"
              className="btn btn-success btn_contact"
              value="Send"
              target="_blank"
            />
          </fieldset>
