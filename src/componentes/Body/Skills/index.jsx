...
export default function Skills() {
  return (
    <>
      <section
        id="Home"
        className="background bg-image-black container-fluid hidden"
        onLoad={Loading}
      >
        <div className="background_titles hidden">
          ...
          <h2 className="profission" id="profission">
            Web Developer
          </h2>
        </div>

        <div className="about hidden">
          <p className="description" id="aboutMe">
          ...
          <div className="div_icons_social">
            ...
            >
              <i className="icons_first bi bi-linkedin"></i>
            </a>
            ...
            >
              <i className="icons_first bi bi-instagram"></i>
            </a>
            ...
            >
              <i className="icons_first bi bi-github"></i>
            </a>
        ...
        <div className="skills_square">
          <div className="square">
            <div className="square_alinhado">
              <i
                className="icons_skills fa-brands fa-html5"
                style={{ color: "#ff651e" }}
              ></i>
              <p>HTML</p>
            </div>
          ...
          <div className="square">
            <div className="square_alinhado">
              <i
                className="icons_skills fa-brands fa-css3-alt"
                style={{ color: "#0062f2" }}
              ></i>
              <p>CSS</p>
            </div>
          ...
          <div className="square">
            <div className="square_alinhado">
              <i
                className="icons_skills fa-brands fa-square-js"
                style={{ color: "#ffdf00" }}
              ></i>
              <p>Javascript</p>
            </div>
          ...
          <div className="square">
            <div className="square_alinhado">
              <i
                className="icons_skills lni lni-typescript"
                style={{ color: "#0062f2" }}
              ></i>
              <p>Typescript</p>
            </div>
          ...
          <div className="square">
            <div className="square_alinhado">
              <i
                className="icons_skills fa-brands fa-sass"
                style={{ color: "#cf649a" }}
              ></i>
              <p>SASS</p>
            </div>
          ...
          <div className="square">
            <div className="square_alinhado">
              <i
                className="icons_skills fa-brands fa-react"
                style={{ color: "#106fff" }}
              ></i>
              <p>ReactJs</p>
            </div>
          ...
          <div className="square">
            <div className="square_alinhado">
              <i
                className="icons_skills lni lni-tailwindcss"
                style={{ color: "#106fff" }}
              ></i>
              <p>Tailwind</p>
            </div>
          ...
          <div className="square">
            <div className="square_alinhado">
              <i
                className="icons_skills fa-brands fa-bootstrap"
                style={{ color: "#8511FA" }}
              ></i>
              <p>Bootstrap</p>
            </div>
